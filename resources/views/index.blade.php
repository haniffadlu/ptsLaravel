  ...
  <div class="site-wrap">
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="#work-section" class="nav-link">Tabung</a></li>
                <li>
                  <a href="#services-section" class="nav-link">Bola</a>
                </li>
                <li><a href="#blog-section" class="nav-link">Kerucut</a></li>
    ...
    <section class="site-section" id="work-section">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <a href="{{url('images/img_1.jpg')}}" class="media-1" data-fancybox="gallery">
          ...
          <div class="col-md-6 col-lg-4">
            <a href="{{url('images/img_2.jpg')}}" class="media-1" data-fancybox="gallery">
              <img src="{{url('images/img_2.jpg')}}" alt="Image" class="img-fluid">
              <div class="media-1-content">
                <h2>Simple Woman</h2>
          ...
          <div class="col-md-6 col-lg-4">
            <a href="{{url('images/img_3.jpg')}}" class="media-1" data-fancybox="gallery">
              <img src="{{url('images/img_3.jpg')}}" alt="Image" class="img-fluid">
              <div class="media-1-content">
                <h2>Fruits</h2>
          ...
          <div class="col-md-6 col-lg-4">
            <a href="{{url('images/img_4.jpg')}}" class="media-1" data-fancybox="gallery">
              <img src="{{url('images/img_4.jpg')}}" alt="Image" class="img-fluid">
              <div class="media-1-content">
          ...
          <div class="col-md-6 col-lg-4">
            <a href="{{url('images/img_5.jpg')}}" class="media-1" data-fancybox="gallery">
              <img src="{{url('images/img_5.jpg')}}" alt="Image" class="img-fluid">
              <div class="media-1-content">
                <h2>Handy Food</h2>
                <span class="category">Branding</span>
              </div>
          ...
          <div class="col-md-6 col-lg-4">
            <a href="{{url('images/img_6.jpg')}}" class="media-1" data-fancybox="gallery">
              <img src="{{url('images/img_6.jpg')}}" alt="Image" class="img-fluid">
              <div class="media-1-content">
                <h2>Cat With Cup</h2>
                <span class="category">Website</span>
              </div>
          ...
          <div class="col-12 bg-black w-100 ft-feature-1-content">
            <div class="row align-items-center">
              <div class="col-lg-5">
                  ...
                  <img src="{{url('images/about_1.jpg')}}" alt="Image" class="img-fluid mb-4 mb-lg-0">
      ...
      <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="{{url('images/person_3.jpg')}}" alt="Image" class="w-50 img-fluid mb-3"></div>
                <p>John Smith</p>
              </figure>
            </div>
          </div>
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="{{url('images/person_2.jpg')}}" alt="Image" class="w-50 img-fluid mb-3"></div>
          ...
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="{{url('images/person_4.jpg')}}" alt="Image" class="w-50 img-fluid mb-3"></div>
                <p>Robert Spears</p>
              </figure>
          ...
          <div>
            <div class="testimonial">
              ...
              <figure class="mb-4 d-flex align-items-center justify-content-center">
                <div><img src="{{url('images/person_5.jpg')}}" alt="Image" class="w-50 img-fluid mb-3"></div>
                <p>Bruce Rogers</p>
              </figure>
      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md-5 ml-auto mb-5 order-md-2" data-aos="fade">
            <img src="{{url('images/about_1.jpg')}}" alt="Image" class="img-fluid rounded">
          </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <div class="person text-center">
              <img src="{{url('images/person_2.jpg')}}" alt="Image" class="img-fluid rounded-circle w-50 mb-5">
              <h3>John Rooster</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <div class="person text-center">
              <img src="{{url('images/person_3.jpg')}}" alt="Image" class="img-fluid rounded-circle w-50 mb-5">
              <h3>Tom Sharp</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="300">
            <div class="person text-center">
              <img src="{{url('images/person_4.jpg')}}" alt="Image" class="img-fluid rounded-circle w-50 mb-5">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              <a href="single.html"><img src="{{url('images/img_1.jpg')}}" alt="Image" class="img-fluid"></a>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              <a href="single.html"><img src="{{url('images/img_2.jpg')}}" alt="Image" class="img-fluid"></a>
              <h2 class="font-size-regular"><a href="single.html">Create Beautiful Website In Less Than An Hour</a></h2>
